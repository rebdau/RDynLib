...
```{r}
pth <- "C:/Users/amentag/Desktop/these/Ahlam/these/equip_msdata/database_FTMS_neg/CSV"
dir(pth)
```
...
```{r}
con <- dbConnect(RSQLite::SQLite(), "C:/Users/amentag/Desktop/these/These/clones/RDynlib/data/DyLib_FTMS_neg2.sqlite")
dbListTables(con)
