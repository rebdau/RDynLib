...
```{r}
pth <- "C:/Users/amentag/Desktop/these/Ahlam/these/equip_msdata/database_FTMS_pos/CSV"
dir(pth)
```
...
```{r}
dbf <- file.path("C:/Users/amentag/Desktop/these/These/clones/RDynlib/data", "DyLib_FTMS_pos2.sqlite")
...
```{r}
con <- dbConnect(RSQLite::SQLite(), "C:/Users/amentag/Desktop/these/These/clones/RDynlib/data/DyLib_FTMS_pos2.sqlite")
dbListTables(con)
