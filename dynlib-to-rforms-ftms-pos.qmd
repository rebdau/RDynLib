...
```{r}
names(compound_add_df) <- sub("^HuN$", "HuN_mixed", names(compound_add_df))
names(compound_add_df) <- sub("^HaN$", "HaN_mixed", names(compound_add_df))
names(compound_add_df) <- sub("^GuN$", "GuN_mixed", names(compound_add_df))
names(compound_add_df) <- sub("^GaN$", "GaN_mixed", names(compound_add_df))
names(compound_add_df) <- sub("^SuN$", "SuN_mixed", names(compound_add_df))
names(compound_add_df) <- sub("^SaN$", "SaN_mixed", names(compound_add_df))
